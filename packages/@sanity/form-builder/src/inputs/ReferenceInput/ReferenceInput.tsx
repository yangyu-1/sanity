          ...
          <>
            ...
            >
              <Card
                ...
                border
                radius={1}
                tone={referenceInfoLoadError || errors.length > 0 ? 'critical' : 'default'}
              >
                <Flex align="center">
                  <Card
                    flex={1}
                    ...
                    ref={ref}
                  >
                    {isReferenceInfoLoading || referenceInfoLoadError ? (
                    ...
                    ) : referenceInfo?.draft.availability.available ||
                      referenceInfo?.published.availability.available ? (
                      <PreviewComponent
                    ...
                    <MenuButton
                      ...
                      menu={
                        <Menu>
                          ...
                          />
                          <MenuDivider />
                          <MenuItem as={OpenLink} text="Open in new tab" icon={OpenInNewTabIcon} />
                        </Menu>
                      }
                      placement="right"
                      popover={{portal: true, tone: 'default'}}
